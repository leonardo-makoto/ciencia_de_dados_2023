...
# note que Triglic estyá como chr e Diabete, que é a variável resposta (e deve estar em factor), está em num
...
amostra <- sample(c(T,F), nrow(db_completas), replace = TRUE , prob = c(0.7, 0.3))


treino <- db_completas[amostra, ]
teste <- db_completas[!amostra,]
